...
This table lists the configuration variables required to operate EclecticIQ app. These variables are specified when configuring a Intelligence Center integration asset in Splunk SOAR.
